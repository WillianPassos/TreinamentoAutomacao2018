...
public class CadastroContaMercadoLivre extends BaseTest {
	...
	public void confirmo_que_ja_tenho_um_cadastro() throws Throwable {
		page.Entrar();
		BaseTest.takeScreenshot();
	...
	public void insiro_minha_senha_novamente_para_entrar_na_conta_exixtente(DataTable arg2) throws Throwable {
		Map<String, String> list = arg2.asMap(String.class, String.class);
		page.setSenhaConfirmar(list.get("Senha"));
		BaseTest.takeScreenshot();
		page.ConfirmarContaEntrar();
		BaseTest.takeScreenshot();
		DriverFactory.killDriver();
	}
